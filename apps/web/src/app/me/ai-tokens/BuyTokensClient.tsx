...
export default function BuyTokensClient({
  ...
  // Gói có nhiều token nhất trên mỗi đồng bỏ ra — không cứng ID để seed thêm
  // gói mới vẫn tự nhận đúng huy hiệu.
  const bestValueId = packages.reduce<string | null>((best, p) => {
    if (!best) return p.id;
