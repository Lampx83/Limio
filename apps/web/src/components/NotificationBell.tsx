...
const ICON: Record<string, { Icon: typeof Bell; cls: string }> = {
  ...
  tournament:        { Icon: Trophy, cls: "bg-amber-100 text-amber-700 dark:bg-amber-950/40 dark:text-amber-300" },
  tournament_cancel: { Icon: Ban,    cls: "bg-slate-200 text-slate-600 dark:bg-slate-700 dark:text-slate-300" },
  deadline:          { Icon: Clock,  cls: "bg-rose-100 text-rose-700 dark:bg-rose-950/40 dark:text-rose-300" },
  team:              { Icon: Users,  cls: "bg-sky-100 text-sky-700 dark:bg-sky-950/40 dark:text-sky-300" },
  prize:             { Icon: Award,  cls: "bg-emerald-100 text-emerald-700 dark:bg-emerald-950/40 dark:text-emerald-300" },
